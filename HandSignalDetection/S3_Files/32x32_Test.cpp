...
namespace {
  ...
  constexpr int MODEL_W = 32;
  constexpr int MODEL_H = 32;
...
bool preprocessImage(camera_fb_t *fb) {
  ...
  // Resize from 106x94 to 32x32 and convert to grayscale [0,1]
...
void sendIndexPage(WiFiClient &client) {
  ...
  client.println("<p style=\"color:#888;\">Live Camera (160x120 → cropped to 106x94 → resized to 32x32)</p>");
